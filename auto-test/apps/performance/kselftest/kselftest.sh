...
print_info $? non-empty-file
print_info $? empty-file
print_info $? read-only-file
print_info $? delete-empty-file
print_info $? delet-no-empty
print_info $? open-the-link
print_info $? create-valid-files
print_info $? create-invalid-file
parse_output
